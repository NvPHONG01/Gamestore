...
const Footer = () => {
  ...
  return (
    <div style={{ backgroundColor: '#0C9BDA', height: 592, justifyContent: "center", display: "flex", marginTop: '50px' }}>
      <div style={{ width: 1440, backgroundColor: '#0C9BDA', height: 592, display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: 1440, backgroundColor: '#0C9BDA' }}>
